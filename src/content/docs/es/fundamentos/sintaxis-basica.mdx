...
# Sintaxis Básica del Lenguaje Quetzal
...
- [Funciones](/es/fundamentos/funciones) - Cómo definir y usar funciones
- [Estructuras de Control](/es/fundamentos/estructuras-control) - Condicionales y bucles
- [Listas y Objetos](/es/fundamentos/listas-objetos) - Trabajo con estructuras de datos complejas
